...
description: Comprehensive guide for managing project tasks using the Backlog.md CLI tool. Activate when user mentions tasks, backlog, acceptance criteria, task creation/editing, implementation plans, or asks about project management workflow. Keywords include 'task', 'backlog', 'AC', 'implementation plan', 'definition of done', 'todo'.
