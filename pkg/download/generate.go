...
//go:generate go run go.uber.org/mock/mockgen -package mocks -destination mocks/http/mock_http_client.go github.com/kasuboski/mediaz/pkg/download HTTPClient
