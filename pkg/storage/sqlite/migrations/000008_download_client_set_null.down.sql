-- Migration 000008 down: Remove ON DELETE SET NULL from download_client_id foreign keys
-- Reverts to original behavior where deleting a download client with references fails

PRAGMA foreign_keys=off;

-- Recreate movie_transition without ON DELETE SET NULL
...
-- Recreate season_transition without ON DELETE SET NULL
...
-- Recreate episode_transition without ON DELETE SET NULL
