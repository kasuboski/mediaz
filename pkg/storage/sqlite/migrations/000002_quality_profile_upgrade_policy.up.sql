...
-- 3. Fixes foreign key bug in quality_profile_item

PRAGMA foreign_keys = OFF;

DROP INDEX IF EXISTS idx_quality_definition_quality_id;

-- Recreate quality_profile table with nullable cutoff_quality_id
...
-- Recreate quality_profile_item table with corrected foreign key
-- FIXED: Now references quality_definition(id) instead of quality_definition(quality_id)
